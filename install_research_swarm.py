...
required = [
    ROOT / "research_client.py",
    ROOT / "research_writer.py",
    ROOT / "autonomous_lab_v2.py",
]
...
if '"RESEARCH_FACTORY"' not in text:
...
'''
    ...
    if anchor not in text:
        ...
        raise SystemExit(
            "Could not find PROCESS_SPECS anchor."
        )
    ...
    print(
        "✅ RESEARCH_FACTORY registered in autonomous_lab_v2.py"
    )
    ...
    print(
        "✅ RESEARCH_FACTORY already registered"
    )
