...
# Many clients may connect simultaneously, but all SQLite
# mutations remain strictly serialized through this lock.
    ...
    try:
        ...
        with conn:
            ...
            while b"\n" not in buf:
                ...
                # Safety limit against malformed clients.
                if len(buf) > 16 * 1024 * 1024:
                    raise RuntimeError(
                        "request exceeds 16MB"
                    )
            ...
            try:
                ...
                # The DB operation may already have succeeded.
                # Losing the client must never kill the writer.
                print(
        ...
        # One malformed/dead client must never terminate server.
        print(
